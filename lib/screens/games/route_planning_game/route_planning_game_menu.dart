...
class RoutePlanningGameMenu extends StatefulWidget {
  //static const String id = "RoutePlanningGameMenu";

  const RoutePlanningGameMenu({super.key});
  //final RoutePlanningGame game;
  @override
  State<RoutePlanningGameMenu> createState() => _RoutePlanningGameMenuState();
}

class _RoutePlanningGameMenuState extends State<RoutePlanningGameMenu>
  ...
  void startGame() {
    if (buttonEnabled) {
      ...
      _controller.forward().whenComplete(() {
        context.pushNamed('route_planning_game');
      });
                        ...
                        child: FractionallySizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              ButtonWithText(text: '返回', onTapFunction: goBack),
                            ],
                          ),
                        ),
                      ),
